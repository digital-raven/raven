...
let
  ...
  common = import ../../host/configuration.nix;
in
{
  ...
  users.users.master = {
    ...
    initialPassword = "master"; # Default password (CHANGE THIS after first login with passwd)
    extraGroups = [
      "docker" # For display/graphics access
